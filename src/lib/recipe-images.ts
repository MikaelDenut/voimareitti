...
const PH = (slug: string) => `/img/placeholders/placeholder-${slug}.webp`;
const ROLE = (role: string) => `/img/placeholders/role-${role}.webp`;        // role-protein.webp ...
const GROUP = (key: string) => `/img/placeholders/group-${key}.webp`;        // group-protein.webp ...
